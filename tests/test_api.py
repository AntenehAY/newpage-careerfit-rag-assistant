...
from app.api.dependencies import get_embedding_service, get_rag_chain, get_vector_store
...
def mock_embedding_service():
    """Mock EmbeddingService for /health endpoint."""
    mock = MagicMock()
    mock.embed_text.return_value = [0.0] * 384  # Mock embedding vector
    return mock
...
@pytest.fixture
def client(mock_vector_store, mock_rag_chain, mock_embedding_service, temp_registry, temp_uploads_dir):
